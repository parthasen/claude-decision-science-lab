...
- `guides/distribute-as-plugins.md` — maintainer how-to for packaging skills as Claude Code plugins and publishing a marketplace, documenting the exact steps used to build this repo.
